...
public class GenericBSTClassMain
   {
    ...
    private static final int sortBy = StateDataClass.SORT_BY_STATE_NAME;
    private static final int sortDir = StateDataClass.SORT_FORWARD;
    
    
      public static void main(String[] args)
         {
          Generic_BST_Class<StateDataClass> testClass;
//          StateDataClass testItem = new StateDataClass( StateDataClass.SORT_BY_STATE_NAME, 
//                                                               StateDataClass.SORT_FORWARD );
          testClass = uploadData( "inData.txt" );
          
          System.out.println( "\nInorder Display:" );
          
          testClass.displayTree( Generic_BST_Class.IN_TRAVERSE );
        
/*          System.out.println( "\nPreorder Display:" );
          
          testClass.displayTree( Generic_BST_Class.PRE_TRAVERSE );
          
          System.out.println( "\nPostorder Display:" );
          
          testClass.displayTree( Generic_BST_Class.POST_TRAVERSE );
*/
          System.out.println();
    ...
    public static StateDataClass removeItem( Generic_BST_Class<StateDataClass> bst, String stateName )
       {
        return bst.removeItem( new StateDataClass( stateName, "", 0, 0.0, 0, 0 ) );
       }
    
    public static StateDataClass searchForItem( Generic_BST_Class<StateDataClass> bst, String stateName )
       {
       ...
       */
      private static Generic_BST_Class<StateDataClass> uploadData( String fileName )
         {
          String stateName, stateInit;
          int numInst, lowTemp, highTemp;
          double avgTemp;
          StateDataClass dataItem;
          Generic_BST_Class<StateDataClass> newData = new Generic_BST_Class<StateDataClass>();
